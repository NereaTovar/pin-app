...
export const pinMock: DetailedPin[] = [
  ...
  },
  {
    ...
    pinDescription:
      "It is a special recognition awarded to those employees who have demonstrated exceptional commitment to Rindus' growth and development by consistently referring high quality candidates. This pin symbolizes their dedication, insight in identifying talent and their crucial role in building a strong and dynamic team. You get this pin with 3 excellent referrals.",
  },
  {
    id: "3",
    imagePin: TopPicker,
